...
//Parameters: [IN] T *pNodeData. Holds the entry which is to be added.
//Description: This function adds node to Singly Linear Linked List.
//Returns: BOOLEAN.If the function succeeds, the return value is TRUE.If the function fails, the return value is FALSE.
template <typename T>
BOOL 
...
//	Parameters: NONE
//	Description:This function displays Singly Linear Linked List.
//	Returns: void
template <typename T>
void 
...
//Parameters: [IN] GEN_LIST<T> **ppListToBeAppended.List which is to be appended to an existing list.
//Description:This function appends node inn Singly Linear Linked List
//Returns: BOOLEAN.If the function succeeds, the return value is TRUE. If the function fails, the return value is FALSE.
template <typename T> 
BOOL
...
//	Parameters: NONE
//	Description:This function counts nodes in Singly Linear Linked List.
//	Returns: int.Number of nodes in generic list
template <typename T>
int 
...
//Parameters: [IN] GEN_LIST<T> data.Holds head data to be searched.
//Description:This function search perticular data in Singly Linear Linked List & return the position at which data is found.
//Returns: int. Position at which data is found in generic list
template <typename T>
int 
...
//Parameters:[IN] GEN_LIST<T> data. Holds head data to be searched.
//Description:This function search perticular data in Singly Linear Linked List & return number of occurances of that data.
//Returns: int. Number of times data is found in generic list
template <typename T>
int 
...
//Parameters: [IN] int pos.Holds the the position. [IN] T *pNodeData.Holds the entry which is to be added.
...
//Parameters:NONE.[IN] int pos.Holds the the position.
//Description:This function deletes node from specified position in Singly Linear Linked List.
//Returns:BOOLEAN.If the function succeeds, the return value is TRUE. If the function fails, the return value is FALSE.
template <typename T>
BOOL 
...
template <typename T>
BOOL
Doubly_linkedList<T>::AddToGenListFirst (T *pNodeData)
{
...
//Function Name:AddToGenListLast
//Parameters:[IN] GEN_DLIST<T> **ppListToBeAppended. List which is to be appended to an existing list.
//Description:This function appends node in Doubly Linear Linked List.
//Returns:BOOLEAN.If the function succeeds, the return value is TRUE.If the function fails, the return value is FALSE.
template <typename T>
BOOL
Doubly_linkedList<T>::AddToGenListLast (T *pNodeData)
{
	GEN_DLIST<T> *pNewNode = NULL;
...
//	Function Name: DisplayGenList
//	Parameters: [IN] GEN_DLIST<T> *pListHead.Holds head pointer of list.
...
//Function Name: SearchFirstOccurance
//Parameters:[IN] GEN_DLIST<T> data.Holds head data to be searched.
//Description:This function search perticular data in Doubly Linear Linked List & return the position at which data is found.
//Returns:int.Position at which data is found in generic list
template <typename T>
int Doubly_linkedList<T>::SearchFirstOccurance(T data)	// Data to be searched 
{
	int CountNode = 0;
	GEN_DLIST<T> *pTempNode = pHead;
	// Traverse the linked list till end
...
//Function Name:SearchAllOccurance
//Parameters:[IN] GEN_DLIST<T> data.Holds head data to be searched.
//Description:This function search perticular data in Doubly Linear Linked List & return number of occurances of that data.
//Returns:int.Number of times data is found in generic list
template <typename T>
...
BOOL Doubly_linkedList<T>::InsertAtPosition(int pos, T* pNodeData)
  // Position at which node is inserted // Data member of the node								
{
	int i = 1;
...
//Function Name: DeleteAtPosition
//Parameters:[IN] int pos.Holds the the position.
//Description:This function deletes node from specified position in Doubly Linear Linked List.
//Returns:BOOLEAN.If the function succeeds, the return value is TRUE.If the function fails, the return value is FALSE.
template <typename T>
BOOL 
...
//	Parameters:NONE
//	Description:Function which display the Doubly Linear Linked List in reverse manner.
//	Returns:void
template <typename T>
BOOL
...
template <typename T>
BOOL 
Singly_linkedList_Circular<T> ::AddToGenListFirst (T *pNodeData)
{
	GEN_LIST<T> *pNewNode;
	if ( NULL == pNodeData )
	{return FALSE;}
...
//	Function Name: DisplayGenList
//	Parameters:NONE
//	Description:This function displays Singly Circular Linked List.
//	Returns:void
template <typename T>
void 
...
template <typename T> 
BOOL
Singly_linkedList_Circular<T>::AddToGenListLast (T *pNodeData)
{
	GEN_LIST<T> *pNewNode;
	GEN_LIST<T> *pTempNode;
	pTempNode = pHead;
...
//Function Name:SearchFirstOccurance
//Parameters:[IN] GEN_LIST<T> data.Holds head data to be searched.
//Description:This function search perticular data in Singly Circular Linked List & return the position at which data is found.
//Returns:int.Position at which data is found in generic list
template <typename T>
int 
Singly_linkedList_Circular<T>::SearchFirstOccurance(T data)
{
	int CountNode = 0;
	GEN_LIST<T> *pListHead = pHead;
	// Traverse the linked list till end
...
//Function Name:SearchAllOccurance
//Parameters:[IN] GEN_LIST<T> data.Holds head data to be searched.
//Description:This function search perticular data in Singly Circular Linked List & return number of occurances of that data.
//Returns: int. Number of times data is found in generic list
template <typename T>
int 
Singly_linkedList_Circular<T>::SearchAllOccurance(T data)
{
	int CountNode = 0;
	GEN_LIST<T> *pListHead = pHead;
	// Traverse the linked list till end
...
template <typename T>
BOOL 
Singly_linkedList_Circular<T>::InsertAtPosition( int pos,T* pNodeData)
{
	int i = 1;
	GEN_LIST<T> *temp = NULL;
	GEN_LIST<T> *pNewNode = NULL;
...
template <typename T>
BOOL 
Singly_linkedList_Circular<T>::DeleteAtPosition(int pos)
{
	if(pos > (CountGenListNode()))
	{return FALSE;}
	else if(pos == 1)
...
template <typename T>
BOOL
Doubly_linkedList_Circular<T>::AddToGenListFirst (T *pNodeData)
{
	GEN_DLIST<T> *pNewNode = NULL;
	if ( NULL == pNodeData)
	{return FALSE;}
...
template <typename T>
BOOL
Doubly_linkedList_Circular<T>::AddToGenListLast (T *pNodeData)
{
	GEN_DLIST<T> *pNewNode = NULL;
	GEN_DLIST<T> *pTempNode = NULL;
	pTempNode = pHead;
...
//	Function Name:CountGenListNode
//	Parameters:[IN] GEN_DLIST<T> *pListHead.Holds head pointer of list.
//	Description:This function counts nodes in Doubly Circular Linked List.
//	Returns:int.Number of nodes in generic list
template <typename T>
...
//Function Name:SearchFirstOccurance
//Parameters:[IN] GEN_DLIST<T> data.Holds head data to be searched.
//Description:This function search perticular data in Doubly Circular Linked List & return the position at which data is found.
//Returns:int. Position at which data is found in generic list
template <typename T>
int Doubly_linkedList_Circular<T>::SearchFirstOccurance(T data)	// Data to be searched 
{
	int CountNode = 0;
...
//Function Name:SearchAllOccurance
//Parameters:[IN] GEN_DLIST<T> data.Holds head data to be searched.
//Description:This function search perticular data in Doubly Circular Linked List & return number of occurances of that data.
//Returns:int. Number of times data is found in generic list
template <typename T>
...
template <typename T>
BOOL 
Doubly_linkedList_Circular<T>::DeleteAtPosition(int pos)
{
	if(pos > (CountGenListNode( )))
	{return FALSE;}
	else if(pos == 1)
...
//	Function Name:DisplayGenListReverse
//	Parameters:NONE
//	Description:Function which display the list in reverse manner.
//	Returns:void
template <typename T>
BOOL
...
sobj.DisplayGenList();
no = 11;
cout<<endl<<"Element 11 is found at position "<<sobj.SearchFirstOccurance(no)<<endl;
...
scobj.DisplayGenList();
no = 11;
cout<<endl<<"Element 11 is found at position "<<scobj.SearchFirstOccurance(no)<<endl;
